            ...
            <div id="burger-table-rows">
                <div v-for="burger in burgers" :key="burger.id" class="burger-table-row">
                    ...
                    <div>
                        ...
                        <button class="delete-btn" @click="confirmDeleteBurger(burger.id)">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default{
        ...
        methods: {
            ...
            this.$swal({
              position: 'center',
              icon: 'success',
              title: `O status do pedido foi alterado para '${option.toLowerCase()}'!`,
